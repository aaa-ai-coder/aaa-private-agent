...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signInWithPasskey() async {
    await widget.authService.signInWithPasskey();
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Theme.of(context).primaryColor.withOpacity(0.15), width: 1.5),
                      ),
                      child: Icon(Icons.smart_toy_rounded, size: 50, color: Theme.of(context).primaryColor),
                    ),
                    const SizedBox(height: 24),
                    Text('AAA Private Agent', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900, color: isDark ? Colors.white : const Color(0xFF1E293B), letterSpacing: -0.5)),
                    const SizedBox(height: 8),
                    Text('Sign in to your account', style: TextStyle(fontSize: 14, color: isDark ? const Color(0xFF94A3B8) : const Color(0xFF475569))),
                    const SizedBox(height: 40),
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: isDark ? const Color(0xFF1E293B) : const Color(0xFFE2E8F0))),
                        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: isDark ? const Color(0xFF1E293B) : const Color(0xFFE2E8F0))),
                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: Theme.of(context).primaryColor, width: 1.8)),
                      ),
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('or', style: TextStyle(color: isDark ? Colors.grey[500] : Colors.grey[400], fontWeight: FontWeight.w500)),
                        ),
                        Expanded(child: Divider(color: isDark ? Colors.grey[700] : Colors.grey[300])),
                      ],
                    ),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: const Text('Sign in with Passkey', style: TextStyle(fontWeight: FontWeight.w600)),
                        style: OutlinedButton.styleFrom(
                          foregroundColor: isDark ? Colors.white : Colors.black87,
                          side: BorderSide(color: isDark ? const Color(0xFF334155) : const Color(0xFFE2E8F0)),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.email_outlined, size: 20, color: Colors.teal),
                        label: const Text('Send Magic Link', style: TextStyle(fontWeight: FontWeight.w600)),
                        style: OutlinedButton.styleFrom(
                          foregroundColor: isDark ? Colors.white : Colors.black87,
                          side: BorderSide(color: isDark ? const Color(0xFF334155) : const Color(0xFFE2E8F0)),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
