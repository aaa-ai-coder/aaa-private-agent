class AppConstants {
  ...
  static const String keyCloudProvider =
      'cloud_provider'; // 'freeai', 'openai', 'anthropic', 'google', 'kimi'
  static const String keyFreeAiModel = 'freeai_model';
  ...
  // Cloud API Endpoints
  static const String freeAiEndpoint =
      'https://text.pollinations.ai/openai'; // keyless, model 'openai-fast'
